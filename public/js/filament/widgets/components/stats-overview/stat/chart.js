...
var Ci = (i) => (i <= 0.0031308 ? i * 12.92 : i ** (1 / 2.4) * 1.055 - 0.055),
	Gt = (i) => (i <= 0.04045 ? i / 12.92 : ((i + 0.055) / 1.055) ** 2.4)
function _a(i, t, e) {
	const s = Gt(mt(i.r)),
		n = Gt(mt(i.g)),
		o = Gt(mt(i.b))
...
function Ma(i, t, e) {
	...
	const s = t[i],
		n = e[i]
	T(s) && T(n) ? te(s, n) : Object.hasOwn(t, i) || (t[i] = Ze(n))
}
...
var qe = (i) => i === 0 || i === 1,
	Us = (i, t, e) => -(2 ** (10 * (i -= 1)) * Math.sin(((i - t) * B) / e)),
	Xs = (i, t, e) => 2 ** (-10 * i) * Math.sin(((i - t) * B) / e) + 1,
	Jt = {
		linear: (i) => i,
		easeInQuad: (i) => i * i,
		easeOutQuad: (i) => -i * (i - 2),
...
var gn = {
	...
	logarithmic(i, t, e) {
		if (i === 0) return "0"
		const s = e[t].significand || i / 10 ** Math.floor(xt(i))
		...
		(x = t[S % a]),
			!x.skip &&
				...
				b !== v &&
					...
					m !== null &&
						w() &&
						(g.push(Js({ start: m, end: S, loop: u, count: a, style: f })),
						(m = null)),
					(P = S),
					(v = b)))
	return (
		m !== null && g.push(Js({ start: m, end: d, loop: u, count: a, style: f })),
		g
	)
}
function cs(i, t) {
...
function mr(i, t) {
	if (!t) return !1
	const e = [],
		s = (n, o) => (qi(o) ? (e.includes(o) || e.push(o), e.indexOf(o)) : o)
			...
			for (d = 0; d < e; d += l) {
				if (
					...
					for (u = 0, f = g.length; u < f; ++u)
						(_ = g[u]),
							!A(_) && !z(_) && ((v = ke(n, b.data, b.gc, v, _)), (y += x))
...
function Pl(i, t, e) {
	const s = Zt(Object.create(null), [e ? V.get(e) : {}, V.get(t), i.defaults])
	V.set(t, s),
...
function Es(i, t, e, s) {
	...
	let n = t[i],
		o = e[i]
	return (
		i === "angle" && ((n = X(n)), (o = X(o))), { property: i, start: n, end: o }
	)
}
function Sc(i, t) {
...
var We = class extends st {
	...
	_updateAnimationTarget(t) {
		const e = this.chart,
			...
			o = s && s.y
		if (n || o) {
			const a = Ie[t.position].call(this, this._active, this._eventPosition)
			if (!a) return
...
function fh(i, { min: t, max: e }) {
	...
	let s = [],
		...
		u = Z(i.min, Math.round((l + h + d * 10 ** o) * a) / a)
	for (; u < e; )
...
function gh(i, t, e) {
	return (
		(e = z(e) ? e : [e]), { w: pn(i, t.string, e), h: e.length * t.lineHeight }
	)
}
