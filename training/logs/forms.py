...
class TrainingLogForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            # Session details
            "session_date": forms.widgets.DateInput(attrs={"type": "date"}, format="%Y-%m-%d"),
            ...
            "ability_to_work_under_pressure_positives": forms.Textarea(attrs={"rows": 3}),
            "ability_to_work_under_pressure_negatives": forms.Textarea(attrs={"rows": 3}),
