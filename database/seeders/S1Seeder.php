    ...
    public function run(): void
    {
        $modules = [
            ...
            [
                ...
                'moodle_course_ids' => [102],
                'moodle_quiz_ids' => [2001, 2002],
                'is_active' => true,
            ],
            [
                'name' => 'S1 Module 3',
                ...
                'moodle_course_ids' => [103],
                'moodle_quiz_ids' => [3001, 3002],
                'is_active' => true,
            ],
            [
                'name' => 'S1 Module 4',
                ...
                'moodle_course_ids' => [104],
                'moodle_quiz_ids' => [4001, 4002],
                'is_active' => true,
            ],
        ];
